                        ...
                        <ul className="navbar-item flex-row ms-lg-auto ms-0 action-area">
                            ...
                            <li className="nav-item dropdown language-dropdown">
                                ...
                                <div className="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                                    <a className="dropdown-item d-flex" href="#"><img src="../src/assets/img/1x1/us.svg" className="flag-width" alt="flag" /> <span className="align-self-center">&nbsp;English</span></a>
                                    <a className="dropdown-item d-flex" href="#"><img src="../src/assets/img/1x1/tr.svg" className="flag-width" alt="flag" /> <span className="align-self-center">&nbsp;Turkish</span></a>
                                    <a className="dropdown-item d-flex" href="#"><img src="../src/assets/img/1x1/br.svg" className="flag-width" alt="flag" /> <span className="align-self-center">&nbsp;Portuguese</span></a>
                                    <a className="dropdown-item d-flex" href="#"><img src="../src/assets/img/1x1/in.svg" className="flag-width" alt="flag" /> <span className="align-self-center">&nbsp;Hindi</span></a>
                                    <a className="dropdown-item d-flex" href="#"><img src="../src/assets/img/1x1/de.svg" className="flag-width" alt="flag" /> <span className="align-self-center">&nbsp;German</span></a>
                                </div>
                            </li>
                                ...
                                <a href="#" className="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <div className="avatar-container">
                                        <div className="avatar avatar-sm avatar-indicators avatar-online">
                                            <img alt="avatar" src="../src/assets/img/profile-30.png" className="rounded-circle" />
                                        </div>
                                    </div>
                                </a>
